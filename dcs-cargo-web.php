...
<div style="margin:1% 1%;">
    ...
    <!-- table section -->
		<div style="float:left; width:34%;">
		    <table style="width:100%; border-spacing:0;" border="1" cellpadding="13">
				...
				<tr>
                    <td>Freight</td>
					<td><?php echo $booking->paid_freight; ?></td>
					<td><?php echo $booking->fod_freight; ?></td>
                </tr>
				<tr>
                ...
                <tr>
                    <td>IGST</td>
					<td><?php echo $booking->paid_igst; ?></td>
					<td><?php echo $booking->fod_igst; ?></td>
                </tr>
				<tr>
                    <td>Misc.</td>
				...
				<!-- <tr>
                    <td><b>Sub Total</b></td>
					<td>
						<?php echo $booking->paid_dkt_charges + $booking->paid_freight + $booking->paid_service_charges + $booking->paid_fov + $booking->paid_cod + $booking->paid_misc
                                 ?>
					</td>
					<td>
					</td>
					<td>
						<?php echo $booking->fod_dkt_charges + $booking->fod_freight + $booking->fod_service_charges + $booking->fod_fov + $booking->fod_cod + $booking->fod_misc
                                 ?>
					</td>
					<td>
					</td>
	...
	<div style="text-align:center; margin-top:2%;">
		<?php if(! request('showWendEmail') ): ?>
			<a id="sendEmail" style="color:black; text-decoration:none; border-radius:50px; border:1px solid black; padding:1% 6%; transition:all .5s;" href="http://zippy.co.in/dcs-cargo-web.php?booking_id=<?php echo $booking->id; ?>&showWendEmail=1&sendEmail=1">Mail e-Consignment Note</a>
		<?php else: ?>
...
<?php 
		function get_inputs_data ($booking, $customer) {
	        ...
	        $inputs['freight_paid'] = $booking->paid_freight ? $booking->paid_freight : ''; // $booking->paid_freight;
	        ...
	        $inputs['freight_fod'] = $booking->fod_freight ? $booking->fod_freight : ''; // $booking->fod_freight;
	        ...
	        $inputs['grandtotal_paid'] = $gt ? $gt : '';
	        //Amount in world
	        $inputs['amount'] = $gt ? getAmountToWord($gt) : '';
