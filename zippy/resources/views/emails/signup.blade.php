                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" align="center" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#289CDC;'><span class="specbundle2"><span class="font1">Welcome to&nbsp; {{ config('app.name') }}</span></span></p>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align='center'>
                                                                        <p >
                                                                            ...
                                                                            <br>
                                                                            Regards,<br>
                                                                            <span style='color:#222222;'>{{ config('app.name') }}</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
