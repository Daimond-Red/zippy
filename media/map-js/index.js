...
const firebaseConfig = {
    apiKey: "AIzaSyBQ0OfK2e94HHreCtYkQ7IzpZChEdK43C8",
    authDomain: "zippy-1531833947039.firebaseapp.com",
    databaseURL: "https://zippy-1531833947039.firebaseio.com",
    projectId: "zippy-1531833947039",
    storageBucket: "zippy-1531833947039.appspot.com",
    messagingSenderId: "686009473006"
};
...
function initMap() {
    ...
    //     center: new google.maps.LatLng(37.40935, -122.12266),
    //     zoom:10,
    ...
    var pointA = new google.maps.LatLng(aLat, aLng),
        pointB = new google.maps.LatLng(bLat, bLng),
        myOptions = {
            zoom: 10,
            center: pointA
        },
    ...
    db.ref('map').on('value', snapshot => {
        ...
        for (let key in busLocationMarkers) {
            if (val === null || !(key in val.markers)) {
        ...
        for (let key in val.markers) {
            const bus = val.markers[key];
