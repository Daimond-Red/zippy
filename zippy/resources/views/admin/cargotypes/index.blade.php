...
@section('header')
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator"> Type of cargos </h3>
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item"><span class="m-nav__link-text">Type of cargos</span></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">Type of cargos</h3>
                </div>
            </div>
                ...
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <button
                            ...
                            data-href="{{ route('admin.cargos.create') }}"
                            data-title="Add new"
                        >
                            Add New
                        </button>
                        ...
                        <td data-label="Action">
                            <span class="">
                                <button
                                   ...
                                   title="Edit details"
                                   data-href="{{ route('admin.cargos.edit', $model->id) }}"
                                   data-title="Edit"
                                >
                                ...
                                <a
                                    href="{{ route('admin.cargos.delete', $model->id) }}"
...
@section('script')
    <script>
        $(document).ready(function(){
            ...
            $('.cargotype-menu').addClass('m-menu__item--active');
        });
    </script>
@stop