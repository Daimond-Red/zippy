            ...
            <table class="table table-bordered table-hover table-mobile">
                ...
                @foreach( $collection as $model )
                    <tr>
                        ...
                        <td data-label="Name">{{ $model->first_name }}</td>
                        <td data-label="Mobile No.">{{ $model->mobile_no }}</td>
                        <td data-label="Licence No.">{{ $model->licence_no }}</td>
                        <td data-label="Address">{{ implode(',', [$model->city, $model->state, $model->pincode]) }}</td>
                        <td data-label="Email">{{ $model->email }}</td>
                        <td data-label="Aadhar No.">{{ $model->aadhar_no }}</td>
                        <td data-label="DL Validity">{{ $model->dl_valid_upto }}</td>
