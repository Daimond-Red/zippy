            ...
            <table class="table table-sm table-bordered table-hover table-mobile">
                ...
                @foreach( $collection as $model )
                    ...
                    <tr>
                        ...
                        <td data-label="Pickup">{{ optional($model->pickupCityRel)->title }}</td>
                        <td data-label="Drop">{{ optional($model->dropCityRel)->title }}</td>
                        <td data-label="Cargo">
                        ...
                        <td data-label="Status">
                            <span class="m-badge m-badge--primary m-badge--wide" >
                                {{ getBookingStatusText($model) }}
                            </span>
                        </td>
                        <td data-label="Reason">
                            {{ $model->customer_reason }}
                        </td>
