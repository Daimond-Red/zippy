...
<table style="margin:2% 5%; width:90%; color:black; border:1px solid #c3c3c3; border-collapse: collapse;" cellpadding="0" cellspacing="0">
    <tr style="border-bottom:1px solid #c3c3c3;">
        <td colspan="2" style="padding:0% 5%;">
            <img style="margin-bottom: -4px;"  src="logo.png" alt="weedneed logo" width="30%"/>
    ...
    <tr style="border-bottom:1px solid #c3c3c3;">
        <td align="center" style="padding:1% 5%;">
            ...
            <h4 style="margin-top:8px;">CRN2123856</h4>
        </td>
        <td align="center" style="padding:1% 5%;">
            <small style="color:gray;">Date</small>
            <h4 style="margin-top:8px;">14 JUN 18</h4>
        </td>
        <td align="center" style="padding:1% 5%;">
            <small style="color:gray;">Distance Travelled</small>
            <h4 style="margin-top:8px;">5 km</h4>
        </td>
        <td align="center" style="padding:1% 5%;">
    ...
    <tr style="border-bottom:1px solid #c3c3c3;">
        ...
        <td colspan="3" style="padding:1% 5%; font-size:16px; border-bottom:1px solid #c3c3c3;">
            ...
            <span style="display:block; margin-top:8px;">Delhi , 14/Jun/2018 05:58 PM</span>
            <span style="display:block; margin-top:8px;">Sector 1, Bawana , Delhi , 110039 , India</span>
        </td>
    </tr>
            ...
            <table>
                ...
                <tr>
                    <td colspan="2"  style="color:gray; font-size:14px;">
                        ...
                        <p>Please visit <a href="https://porter.in/terms-of-services">https://porter.in/terms-of-services</a> for applicatble T&c</p>
                    </td>
                </tr>
    ...
    <tr style="border-bottom:1px solid #c3c3c3;">
        <td colspan="2" align="center" style="padding:1% 5%;">
            <h4 style="color:gray; margin:0;">Total Porter Credits</h4>
            <h5 style="margin-top:8px; margin-bottom: 0;"><i class="fas fa-rupee-sign"></i> 855</h5>
        </td>
    </tr>
    ...
    <tr style="border-bottom:1px solid #c3c3c3;">
        <td colspan="2" align="left" style="padding:1% 5%;">
            ...
            <h3 style="margin-top:8px;">Sanjay Bhutani</h3>
            <p>Guest</p>
        </td>
    </tr>
    ...
    <tr style="border-bottom:1px solid #c3c3c3;">
        <td colspan="2" align="left" style="padding:1% 5%;">
            ...
            <h3 style="margin-top:8px; margin-bottom: 0;">Sanjay Bhutani</h3>
        </td>
    </tr>
    ...
    <tr style="background:#ececec;">
        <td style="padding: 1% 5%;">
            ...
            <h5 style="color:gray;">info@porter.in</h5>
        </td>
        ...
        <td style="padding: 1% 5%;">
            <h5>Singnature on the behalf of porter</h5>
        </td>
    </tr>
