            ...
            <table class="table table-sm table-bordered table-hover table-mobile">
                ...
                @foreach( $collection as $model )
                    ...
                    <tr>
                        ...
                        <td data-label="Pickup">{{ \App\City::getCitiesNames($model->pickup_city_id) }}</td>
                        <td data-label="Drop">{{ \App\City::getCitiesNames($model->drop_city_id) }}</td>
                        ...
                        <td data-label="Weight (TON)"> {{ $model->actual_gross_weight }} </td>
