...
@section('header')
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator"> Type of vehicles </h3>
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item"><span class="m-nav__link-text">Type of vehicles</span></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">Type of vehicles</h3>
                </div>
            </div>
            ...
            <table class="table table-bordered table-hover table-mobile">
                ...
                @foreach( $collection as $model )
                    <tr>
                        ...
                        <td data-label="Image">
                            <img src="{{ getImageUrl($model->icon) }}" alt="" style="width: 40px;">
                        </td>
                        <td data-label="Title">{{ $model->title }}</td>
                        <td data-label="Code">{{ $model->short_code }}</td>
...
@section('script')
    <script>
        $(document).ready(function(){
            ...
            $('.vehicletype-menu').addClass('m-menu__item--active');
        });
    </script>
@stop